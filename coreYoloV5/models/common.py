...
from coreYoloV5.utils import TryExcept
from coreYoloV5.utils.dataloaders import exif_transpose, letterbox
from coreYoloV5.utils.general import (
    LOGGER,
    ROOT,
    Profile,
    check_requirements,
...
from coreYoloV5.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from coreYoloV5.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from coreYoloV5.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from coreYoloV5.export import export_formats
        from coreYoloV5.utils.downloads import is_url
